...
export const RegistrationSection = () => {
  ...
  const [memberOne, setMemberOne] = useState<Member>({
    name: "",
    studentId: "",
  });
  const [memberTwo, setMemberTwo] = useState<Member>({
    name: "",
    studentId: "",
  });
  const [memberThree, setMemberThree] = useState<Member>({
    name: "",
    studentId: "",
  });
  ...
  const [pending, setPending] = useState(false);
	...
	const hasTimedOut = useMemo(() => {
		let diff = new Date("2025-03-04T12:00:00").getTime() - Date.now();
		return diff <= 0;
	}, []);
    ...
    <section id="register" className="container py-2 md:py-32 ">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        <Card className="w-full bg-muted/60 dark:bg-card">
          <CardHeader className="text-gray-50 text-[2.230rem] text-center">
            Register
          </CardHeader>
          <CardContent
          ...
          >
            <div className="flex flex-col gap-4">
              ...
              <Input
                ...
                value={leaderContact}
                onChange={(e) =>
                  setLeaderContact(e.target.value.replaceAll(/[^\d+]/g, ""))
                }
              />
              <Input
                type="text"
                ...
                value={leaderSid}
                onChange={(e) =>
                  setLeaderSid(e.target.value.replaceAll(/[^\d+]/g, ""))
                }
              />
              <Input
                type="email"
              ...
              <div className="flex flex-col gap-4">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setMemberOne({
                      name: memberOne.name,
                      studentId: e.target.value.replaceAll(/[^\d+]/g, ""),
                    })
                  }
                />
              </div>
              ...
              <div className="flex flex-col gap-4">
                <Input
                  ...
                  onChange={(e) =>
                    setMemberThree({
                      name: e.target.value,
                      studentId: memberThree.studentId,
                    })
                  }
                />
                <Input
            ...
            <div className="flex flex-col mt-4">
              <i className="text-base text-red-400">
                *At-least 02 members are required.
              </i>
              <i className="text-base text-red-400">
                *Team Leaders should register using their NSBM email.
              </i>
            </div>
            ...
            <div
              id="success"
              className="bg-transparent shadow-lg p-0 backdrop:bg-neutral-800/50"
              popover=""
            >

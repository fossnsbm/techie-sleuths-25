...
const navigationMenuTriggerStyle = cva(
	"group inline-flex h-10 w-max items-center justify-center rounded-md bg-background hover:underline hover:decoration- px-4 py-2 text-sm  hover:bg-primary/90 font-medium focus:text-accent-foreground focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[active]:bg-primary/80 data-[state=open]:bg-primary/80",
);
